...
# Behaviour for moving towards a target that has been detected but with controlling the squad
...
func moveToAttack(enemy, target, tick):
	...
	# Making sure they enemy gets too their preferred distance from the target
