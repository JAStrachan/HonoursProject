...
export(Vector2) var map_size = Vector2(42,37)
...
func _ready():
	obstacles = obstacles + get_used_cells_by_id(1) + \
	...
	for point in points_array:
		...
		for local_y in range(3):
			for local_x in range(3):
				...
				# We connect the current point with it this comment was not for the diagonal one.
